...
void setup_scr_screen_7(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_7, 320, 240);
    ...
    lv_obj_set_style_bg_color(ui->screen_7, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_7_img_1, 61, 53);
    lv_obj_set_size(ui->screen_7_img_1, 47, 44);
    lv_obj_add_flag(ui->screen_7_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_7_img_1, &_3_RGB565_47x44);
    ...
    ui->screen_7_img_2 = lv_image_create(ui->screen_7);
    lv_obj_set_pos(ui->screen_7_img_2, 61, 126);
    lv_obj_set_size(ui->screen_7_img_2, 47, 44);
    lv_obj_add_flag(ui->screen_7_img_2, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_7_img_2, &_2_RGB565_47x44);
    lv_image_set_pivot(ui->screen_7_img_2, 50,50);
    lv_image_set_rotation(ui->screen_7_img_2, 0);

    //Write style for screen_7_img_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_7_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_7_img_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_7_label_1
    ui->screen_7_label_1 = lv_label_create(ui->screen_7);
    lv_obj_set_pos(ui->screen_7_label_1, 136, 63);
    lv_obj_set_size(ui->screen_7_label_1, 85, 26);
    lv_label_set_text(ui->screen_7_label_1, "心率：74");
    ...
    lv_obj_set_style_text_color(ui->screen_7_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_7_label_1, &lv_font_HYCuHeiJ_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_7_label_2, 136, 142);
    lv_obj_set_size(ui->screen_7_label_2, 134, 21);
    lv_label_set_text(ui->screen_7_label_2, "血氧饱和度：56");
    ...
    lv_obj_set_style_text_font(ui->screen_7_label_2, &lv_font_HYCuHeiJ_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_7_btn_1, 238, 199);
    lv_obj_set_size(ui->screen_7_btn_1, 63, 23);
    lv_obj_add_flag(ui->screen_7_btn_1, LV_OBJ_FLAG_CLICK_FOCUSABLE);
    ui->screen_7_btn_1_label = lv_label_create(ui->screen_7_btn_1);
    lv_label_set_text(ui->screen_7_btn_1_label, "退出");
    ...
    lv_obj_set_style_bg_color(ui->screen_7_btn_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_7_btn_1, &lv_font_HYCuHeiJ_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write style for screen_7_btn_1, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->screen_7_btn_1, 255, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_bg_color(ui->screen_7_btn_1, lv_color_hex(0xff0027), LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_bg_grad_dir(ui->screen_7_btn_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_border_width(ui->screen_7_btn_1, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_radius(ui->screen_7_btn_1, 5, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_shadow_width(ui->screen_7_btn_1, 0, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_text_color(ui->screen_7_btn_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_text_font(ui->screen_7_btn_1, &lv_font_HYCuHeiJ_16, LV_PART_MAIN|LV_STATE_FOCUSED);
    lv_obj_set_style_text_opa(ui->screen_7_btn_1, 255, LV_PART_MAIN|LV_STATE_FOCUSED);

    //Write codes screen_7_sw_1
    ui->screen_7_sw_1 = lv_switch_create(ui->screen_7);
    lv_obj_set_pos(ui->screen_7_sw_1, 40, 202);
    lv_obj_set_size(ui->screen_7_sw_1, 40, 20);

    //Write style for screen_7_sw_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_7_sw_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_7_sw_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_7_sw_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_7_sw_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_7_sw_1, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_7_sw_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write style for screen_7_sw_1, Part: LV_PART_INDICATOR, State: LV_STATE_CHECKED.
    lv_obj_set_style_bg_opa(ui->screen_7_sw_1, 255, LV_PART_INDICATOR|LV_STATE_CHECKED);
    lv_obj_set_style_bg_color(ui->screen_7_sw_1, lv_color_hex(0xff002d), LV_PART_INDICATOR|LV_STATE_CHECKED);
    lv_obj_set_style_bg_grad_dir(ui->screen_7_sw_1, LV_GRAD_DIR_HOR, LV_PART_INDICATOR|LV_STATE_CHECKED);
    lv_obj_set_style_bg_grad_color(ui->screen_7_sw_1, lv_color_hex(0x2195f6), LV_PART_INDICATOR|LV_STATE_CHECKED);
    lv_obj_set_style_bg_main_stop(ui->screen_7_sw_1, 0, LV_PART_INDICATOR|LV_STATE_CHECKED);
    lv_obj_set_style_bg_grad_stop(ui->screen_7_sw_1, 255, LV_PART_INDICATOR|LV_STATE_CHECKED);
    lv_obj_set_style_border_width(ui->screen_7_sw_1, 0, LV_PART_INDICATOR|LV_STATE_CHECKED);

    //Write style for screen_7_sw_1, Part: LV_PART_KNOB, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_7_sw_1, 255, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_7_sw_1, lv_color_hex(0xe73d57), LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_7_sw_1, LV_GRAD_DIR_NONE, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_7_sw_1, 0, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_7_sw_1, 10, LV_PART_KNOB|LV_STATE_DEFAULT);
