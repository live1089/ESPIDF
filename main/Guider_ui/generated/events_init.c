...
static void screen_0_btn_2_event_handler (lv_event_t *e)
{
...
{
    lv_obj_add_event_cb(ui->screen_0_btn_2, screen_0_btn_2_event_handler, LV_EVENT_ALL, ui);
...
static void screen_1_btn_1_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_0, guider_ui.screen_0_del, &guider_ui.screen_1_del, setup_scr_screen_0, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    default:
        break;
...
static void screen_2_btn_1_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_0, guider_ui.screen_0_del, &guider_ui.screen_2_del, setup_scr_screen_0, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    default:
        break;
